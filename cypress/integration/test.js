describe('Todo Test', function() {
    ...
    it('changes first name', function() {
        cy.visit('http://localhost:9000')
        cy.get("h1").first().type("{selectall}").type("na Servas").click()
    ...
    it('changes second name', function() {
        cy.visit('http://localhost:9000')
        cy.get("h1").last().type("{selectall}").type("jo mei")
        cy.contains("jo mei")
    })
    ...
    it('rename subtodo', function() {
        cy.visit('http://localhost:9000')
        cy.get('h1').last().type("{selectall}").type("Grias enk")
    })
    ...
    it('checks lock subtodo', function() {
        cy.visit('http://localhost:9000')
        cy.get("h1").last().type("{selectall}").type("herst oida")
